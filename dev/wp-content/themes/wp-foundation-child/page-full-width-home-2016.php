<?php
/*
Template Name: Full Width Page Home 2016 beta
*/
?>

<?php get_header(home); ?>
<div id="top-love">
<div id="top-home-info"><p>14 Days of Love:<br />
    -try Halo risk-free (unconditional money back guarantee) NOTE: this is NOT a link to our refund page. It's just a reminder that consumers can return it<br />
    -get coupons here (newsletter sign up<br />
    -we're donating 1.5 million bowls to shelters<br />
-Look for this display at a premier indpendent pet store near you!<br />
-More about 14 Days of Free Love (link to a video?) </p></div>
		<div class="row container">
			<div class="twelve columns">
				<header role="banner" id="top-header">
<div id="banner-home-info"><p>14 Days of Love:<br />
    -try Halo risk-free (unconditional money back guarantee) NOTE: this is NOT a link to our refund page. It's just a reminder that consumers can return it<br />
    -get coupons here (newsletter sign up<br />
    -we're donating 1.5 million bowls to shelters<br />
-Look for this display at a premier indpendent pet store near you!<br />
